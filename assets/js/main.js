...
function setHeights(theHeight,theWidth,oheight,multiplyer) {
	...
	//} else {
		$('#bottom-section').height( ( h * .103 ) * multiplyer );
		//$('#top-section').height( ( h * .76 ) * multiplyer );
		//$('#top-section').height( ( h * .52 ) * multiplyer + ($("#top-section .section-text").height() * 2.5) );
		$('#world').height( ( h * .068 ) * multiplyer );
		$('#combat').height( ( h * .068 ) * multiplyer );
		$('#mercenaries').height( ( h * .068 ) * multiplyer );
		$('#monsters').height( ( h * .068 ) * multiplyer );
		$('#community').height( ( h * .068 ) * multiplyer );		
	//}
}
